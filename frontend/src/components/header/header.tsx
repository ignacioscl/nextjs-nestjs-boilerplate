        ...
        <div className="relative flex items-center justify-end bg-white py-3 pl-[70px] pr-3 dark:bg-dark-2 sm:justify-between md:pl-20 md:pr-8 xl:pl-8">
          ...
          <div className="hidden items-center sm:flex">
            <div className="mr-3 hidden lg:block">
              ...
              <p className="text-sm text-body-color dark:text-dark-6">
                Bienvenido al nextjs-nestjs-boilerplate.
              </p>
            </div>
           ...
           {/*} <div>
              <div className="relative mr-3 w-full max-w-[250px] md:max-w-[385px]">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full rounded-lg border border-stroke bg-gray-2 py-[10px] pl-5 pr-10 text-secondary-color outline-none focus:border-primary dark:border-dark-3 dark:bg-dark dark:text-dark-6"
                />
          ...
          <div className="flex items-center justify-end space-x-4">
            ...
            {/*<div className="relative hidden md:block">
              <select className="appearance-none bg-transparent pl-6 pr-5 text-sm font-medium text-body-color outline-none dark:text-dark-6">
              ...
              <img
                ...
                alt="usa"
                className="absolute left-0 top-1/2 h-3 w-5 -translate-y-1/2 rounded-sm"
              />
